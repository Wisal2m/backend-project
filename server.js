...
app.use(function(req, res, next){
    ...
    res.locals.filterUserHTML = function(content){
        return sanitizeHTML(marked.parse(content),{
            allowedTags : ["p","br","ul","li","ol","strong","bold","i","em","h1","h2","h3","h4"],
            allowedAttributes: {}
        })         
    }
...
app.post("/login", (req, res)=>{
 ...
 const ourTokenvalue = jwt.sign(
    ...
    app.get("/post/edit-post/:id", mustBeLoggedIn, (req, res) => {
    ...
    app.post("/post/edit-post/:id", mustBeLoggedIn, (req, res)=>{
        ...
        // if you're not the author, redirect to homepage
            ...
            const updateStatemnet = db.prepare("UPDATE posts SET title = ?, body = ? WHERE id = ?")
            updateStatemnet.run(req.body.title, req.body.body, req.params.id)
...
app.post("/register", (req, res)=>{
    ...
    if(req.body.username  && req.body.username.length > 10) errors.push("username must be maximum of then characters long.")
    ...
    if(req.body.password  && req.body.password.length < 8) errors.push("Password must be atleast eight characters.")
    if(req.body.password  && req.body.password.length > 20) errors.push("Password can exceed of twenty characters long.")
